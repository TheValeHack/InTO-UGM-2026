...
const paketData = [
  {
    name: "Dewekan",
    price: 42000,
    desc: "Try Out, Penilaian IRT, University Fair, Prediksi Peluang Masuk, Variasi Soal UTBK, Rekomendasi Jurusan, Talkshow, Konsumsi"
  },
  {
    name: "Dewekan Kahf",
    price: 59999,
    desc: "Try Out, Penilaian IRT, University Fair, Prediksi Peluang Masuk, Variasi Soal UTBK, Rekomendasi Jurusan, Talkshow, Konsumsi, FREE KAHF + Voucher Diskon Product Kahf 10k"
  },
  {
    name: "Betigo (3 Orang)",
    price: 124000,
      ...
      <div className="max-w-[2160px] mx-auto flex flex-col w-screen relative">
        <section id="hero" className="px-6 md:px-12 lg:px-16 w-full min-h-screen flex flex-col justify-center items-center relative">
          ...
          <div className="flex flex-col gap-2 w-full md:w-fit mt-8 md:mt-0">
            ...
            <BubbleButton scale={1} color="default" className={'text-xl md:text-3xl min-w-full md:min-w-64 py-3 md:py-4'} onClick={() => { router.push("/#paket"); }}>Lihat Paket TO</BubbleButton>
          </div>
        </section>
        ...
        <section id="gallery" className="w-full min-h-screen md:min-h-[75vh] flex justify-center items-center relative">
          ...
          <div className="px-6 md:px-12 lg:px-16 w-full z-30">
            <Gallery className={'mx-auto'} images={[{ src: '/images/1.png', tag: 2020 }, { src: '/images/2.jpg', tag: 2022 }, { src: '/images/3.jpg', tag: 2023 }, { src: '/images/4.jpg', tag: 2024 }, { src: '/images/2025.jpg', tag: 2025 }]} />
          </div>
          <Image
